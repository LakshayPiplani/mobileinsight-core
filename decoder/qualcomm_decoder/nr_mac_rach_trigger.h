...
_decode_nr_mac_rach_trigger(const char* b, int offset, size_t length,
    ...
    case 2: {
        ...
        case 1:
        {
            ...
            _replace_result_int(result, "ML1 State Change", ml1_state_change);
            _replace_result_int(result, "UL config", UL_config);
            ...
            result.push_back({"MSG3 LIST", FieldValue{std::string(msg_list_str)}, ""});
            success = 1;
            break;
        }
        default:
