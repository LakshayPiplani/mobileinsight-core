    ...
    case 4:
        {
            ...
            _replace_result_int(result, "Cell ID",
                    iCellID);
            _replace_result_int(result, "Barred Status",
                    iBarredStatus);
            (void) _map_result_field_to_name(result,
                    "Barred Status",
            ...
            iQRxLevMin -= 256;
            _replace_result_int(result, "Q Rx Lev Min", iQRxLevMin);
            _replace_result_int(result, "Q Rx Lev Min Offset",
                    iQRxLevMinOffset);
            _replace_result_int(result, "P Max", iPMax);
