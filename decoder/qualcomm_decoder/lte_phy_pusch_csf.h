    ...
    case 142:
        {
            ...
            _replace_result_int(result, "Start System Sub-frame Number",iresulttemp);
            iresulttemp =(utemp>>4) & 0x3ff;
            _replace_result_int(result, "Start System Frame Number",iresulttemp);
            iresulttemp =(utemp>>14) & 0xf;
            _replace_result_int(result, "Carrier Index",iresulttemp);
            iresulttemp =(utemp>>18) & 0x1f;
            _replace_result_int(result, "Scell Index",iresulttemp);
            //iresulttemp =(utemp>>23) & 0x1;
            //_replace_result_int(result, "Reserved",iresulttemp);
            //Py_DECREF(old_object);
            iresulttemp =(utemp>>24) & 0x7;
            _replace_result_int(result, "PUSCH Reporting Mode",iresulttemp);
            iresulttemp =(utemp>>27) & 0x1;
            _replace_result_int(result, "Csi Meas Set Index",iresulttemp);
            iresulttemp =(utemp>>28) & 0x3;
            _replace_result_int(result, "Rank Index",iresulttemp);
            iresulttemp =(utemp>>30) & 0xf;
            _replace_result_int(result, "Wideband PMI1",iresulttemp);

            utemp = _search_result_uint(result,"Number of subbands");
            iresulttemp =(utemp>>2) & 0x1f;
            _replace_result_int(result, "Number of subbands",iresulttemp);
            iresulttemp =(utemp>>7) & 0xf;
            _replace_result_int(result, "WideBand CQI CW0",iresulttemp);
            iresulttemp =(utemp>>11) & 0xf;
            _replace_result_int(result, "WideBand CQI CW1",iresulttemp);
            iresulttemp =(utemp>>15) & 0xf;
            _replace_result_int(result, "SubBand Size (k)",iresulttemp);
            iresulttemp =(utemp>>19) & 0x7;
            _replace_result_int(result, "Size M",iresulttemp);
            //iresulttemp =(utemp>>22) & 0x3;
            //_replace_result_int(result, "Reserved",iresulttemp);
            //Py_DECREF(old_object);
            iresulttemp =(utemp>>24) & 0xf;
            _replace_result_int(result, "Single WB PMI",iresulttemp);
            iresulttemp =(utemp>>28) & 0xf;
            _replace_result_int(result, "Single MB PMI",iresulttemp);

            utemp = _search_result_uint(result,"CSF Tx Mode");
            iresulttemp =(utemp>>0) & 0xf;
            _replace_result_int(result, "CSF Tx Mode",iresulttemp);

            utemp = _search_result_uint(result,"Num Csirs Ports");
            iresulttemp =(utemp>>0) & 0xf;
            _replace_result_int(result, "Num Csirs Ports",iresulttemp);
            ...
            _replace_result_int(result, "CRI",iresulttemp);
            //iresulttemp =(utemp>>3) & 0x1;
            //_replace_result_int(result, "Reserved",iresulttemp);
            //Py_DECREF(old_object);
            iresulttemp =(utemp>>4) & 0x3ff;
            _replace_result_int(result, "UL Frame Number",iresulttemp);
            iresulttemp =(utemp>>14) & 0xf;
            _replace_result_int(result, "UL Subframe Number",iresulttemp);
            iresulttemp =(utemp>>18) & 0x7f;
            _replace_result_int(result, "UL Payload Length",iresulttemp);
            //iresulttemp =(utemp>>25) & 0x7ff;
            //_replace_result_int(result_pdcch_item, "Reserved5",iresulttemp);
            //Py_DECREF(old_object);
    ...
    case 102:
        {
            ...
            _replace_result_int(result, "PUSCH Reporting Mode",
                    iPuschReportingMode);
            (void) _map_result_field_to_name(result, "PUSCH Reporting Mode",
                    ValueNamePuschReportingMode,
                    ARRAY_SIZE(ValueNamePuschReportingMode, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "Rank Index",
                    iRankIndex);
            (void) _map_result_field_to_name(result, "Rank Index",
                    ValueNameRankIndex,
                    ARRAY_SIZE(ValueNameRankIndex, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "Number of Subbands",
                    iNumSubbands);
            _replace_result_int(result, "WideBand CQI CW0",
                    iWideBandCQICW0);
            _replace_result_int(result, "WideBand CQI CW1",
                    iWideBandCQICW1);
            _replace_result_int(result, "SubBand Size (k)",
                    iSubBandSize);
            _replace_result_int(result, "Single WB PMI",
                    iSingleWBPMI);
            _replace_result_int(result, "Single MB PMI",
                    iSingleMBPMI);
            _replace_result_int(result, "CSF Tx Mode",
                    iCSFTxMode);
            (void) _map_result_field_to_name(result, "CSF Tx Mode",
                    ValueNameCSFTxMode,
                    ARRAY_SIZE(ValueNameCSFTxMode, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "Carrier Index",
                    iCarrierIndex);
            (void) _map_result_field_to_name(result, "Carrier Index",
                    ValueNameCarrierIndex,
                    ARRAY_SIZE(ValueNameCarrierIndex, ValueName),
    ...
    case 101:
        {
            ...
            (void) _map_result_field_to_name(result, "Rank Index",
                    ...
                    ARRAY_SIZE(ValueNameRankIndex, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "Csi Meas Set Index",
                    iCsiMeasSetIndex);
            ...
            (void) _map_result_field_to_name(result, "Carrier Index",
                    ...
                    ARRAY_SIZE(ValueNameCarrierIndex, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "Num CSIrs Ports",
                    iNumCSIrsPorts);
    ...
    case 103:
        {
            ...
            _replace_result_int(result, "WideBand CQI CW0",iWideBandCQICW0);
