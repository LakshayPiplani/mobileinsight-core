    ...
    case 21:
        {
            ...
            _replace_result_int(result, "Subframe Number", iSubFN);
            _replace_result_int(result, "System Frame Number",
                    iSysFN);
            ...
            _replace_result_int(result, "Demback Mode Select", iDMS);
    ...
    case 42:
        {
            ...
            _replace_result_int(result, "System Frame Number",
                    iSysFN);
            _replace_result_int(result, "Band Width (MHz)", iBandWidth);

            _replace_result_int(result, "CIF Configured", iCC);
    ...
    case 43:
        {
            ...
            _replace_result_int(result, "Num Records", num_record);
            _replace_result_int(result, "Subframe Number", iSubFN);
            _replace_result_int(result, "System Frame Number", iSysFN);
            _replace_result_int(result, "Band Width (MHz)", iBandWidth);
            _replace_result_int(result, "Frame Structure", iFrameStructure);
            (void) _map_result_field_to_name(result, "Frame Structure",
                    ValueNameFrameStructure,
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                FieldList result_record_hypothesis;
                for (int j = 0; j < num_hypothesis; j++) {
                    FieldList result_record_hypothesis_item;
                    ...
                    _replace_result_int(result_record_hypothesis_item,
                            "Aggregation Level", iAggLv);
                    ...
                    unsigned int iNonDecode = _search_result_uint(result_record_hypothesis_item,
                            "Norm Energy Metric");
                    float fNEM = iNonDecode / 65535.0;
                    _replace_result(result_record_hypothesis_item,
                            "Norm Energy Metric", FieldValue{double(fNEM)});
                    ...
                    result_record_hypothesis.push_back({"Ignored", FieldValue{std::move(result_record_hypothesis_item)}, "dict"});
                }

                offset += (11 - num_hypothesis) * 28;
                result_record_item.push_back({"Hypothesis", FieldValue{std::move(result_record_hypothesis)}, "list"});

                result_record.push_back({"Ignored", FieldValue{std::move(result_record_item)}, "dict"});
            }
            result.push_back({"SF", FieldValue{std::move(result_record)}, "list"});
            return offset - start;
        }
    case 101:
        {
    ...
    case 121:
        {
            ...
            _replace_result_int(result, "__pad", __pad);
    ...
    case 141:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                _replace_result_int(result_record_item, "System Frame Number",
                        iSysFN);
                _replace_result_int(result_record_item, "Band Width (MHz)", iBandWidth);

                _replace_result_int(result_record_item, "CIF Configured", iCC);
                (void) _map_result_field_to_name(result_record_item,
                        "CIF Configured",
                        ValueNameTrueOrFalse,
                        ARRAY_SIZE(ValueNameTrueOrFalse, ValueName),
                ...
                (void) _map_result_field_to_name(result_record_item,
                        ...
                        ARRAY_SIZE(ValueNameTrueOrFalse, ValueName),
                        "(MI)Unknown");
                _replace_result_int(result_record_item, "Frame Structure", iFrameStructure);
                (void) _map_result_field_to_name(result_record_item, "Frame Structure",
                        ValueNameFrameStructure,
                        ARRAY_SIZE(ValueNameFrameStructure, ValueName),
                        "(MI)Unknown");
                _replace_result_int(result_record_item, "Num eNB Antennas", iNumAntennas);
                (void) _map_result_field_to_name(result_record_item, "Num eNB Antennas",
                        ...
                        "(MI)Unknown");
                _replace_result_int(result_record_item, "DL CP", iDLCP);
                (void) _map_result_field_to_name(result_record_item,
                        "DL CP",
                        ValueNameNormalOrNot,
                        ARRAY_SIZE(ValueNameNormalOrNot, ValueName),
                        "(MI)Unknown");
                _replace_result_int(result_record_item, "SSC", iSSC);
                _replace_result_int(result_record_item, "CA FDD TDD", iCAFDDTDD);
