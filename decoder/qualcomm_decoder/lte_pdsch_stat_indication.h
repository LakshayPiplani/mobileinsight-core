    ...
    case 36:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                FieldList result_record_item_TB_list;
                for (int i = 0; i < num_TB; i++) {
                    FieldList result_record_item_TB_item;
                    ...
                    result_record_item_TB_list.push_back({"Ignored", FieldValue{std::move(result_record_item_TB_item)}, "dict"});
                }
                result_record_item.push_back({"Transport Blocks", FieldValue{std::move(result_record_item_TB_list)}, "list"});
                if (num_TB == 1) {
