    ...
    case 21:
        {
            ...
            _replace_result_int(result, "Serving Cell ID",
                    iServingCellId);
            _replace_result_int(result, "Number of Records",
                    num_record);
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                _replace_result(result_record_item, "CQI Payload", FieldValue{std::string(strCQIPayload.c_str())});
                ...
                _replace_result_int(result_record_item, "Format",
                        iFormat);
                ...
                _replace_result(result_record_item, "ACK Payload", FieldValue{std::string(strAckPayload.c_str())});

                FieldList result_record_css;
                for (int j = 0; j < 14; j++) {
                    FieldList result_record_css_item;
                    ...
                    result_record_css.push_back({"Ignored", FieldValue{std::move(result_record_css_item)}, "dict"});
                }

                result_record_item.push_back({"Cyclic Shift Seq", FieldValue{std::move(result_record_css)}, "list"});
                ...
                _replace_result(result_record_item,
                        "Tx Resampler", FieldValue{double(fTxResampler)});
    ...
    case 43:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                _replace_result(result_record_item,
                        "Ack Nak Index", FieldValue{std::string(strAckNakIndex.c_str())});
                _replace_result_int(result_record_item,
