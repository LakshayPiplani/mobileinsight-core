            ...
            for (int i = 0; i < n_subpkts; i++) {
                ...
                if (subpkt_id == 30) {
                    ...
                    for (int j = 0; j < num_cells; j++) {
                        ...
                        _replace_result(result_cell_item,
                                "Inst Measured RSRP", FieldValue{double(RSRP)});
                        ...
                        _replace_result(result_cell_item,
                                "Inst Measured RSRQ", FieldValue{double(RSRQ)});
                        ...
                        _replace_result(result_cell_item,
                                "Inst Measured RSSI", FieldValue{double(RSSI)});

                        result_cell.push_back({"Ignored", FieldValue{std::move(result_cell_item)}, "dict"});
                    }
                    result_subpkt.push_back({"Neighbor Cells", FieldValue{std::move(result_cell)}, "list"});
