    ...
    case 1:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                _replace_result_int(result_record_item, "Sub-FN",
                        iSubFN);
                _replace_result_int(result_record_item, "CDRX Event",
                        iCdrxEvent);
    ...
    case 2:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                FieldValue pystr = FieldValue{std::string(strInternalFieldMask.c_str())};
                _replace_result(result_record_item, "Internal Field Mask",
                        pystr);
