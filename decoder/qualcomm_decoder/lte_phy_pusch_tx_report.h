    ...
    case 23:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                _replace_result(result_record_item,
                        "Coding Rate Data", FieldValue{double(fCodingRateData)});
    ...
    case 43:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                strRiPayload += hex;
                _replace_result(result_record_item, "RI Payload", FieldValue{std::string(strRiPayload.c_str())});
                _replace_result_int(result_record_item,
                        "Rate Matched RI Bits", iRateMatchedRiBits);
                _replace_result_int(result_record_item,
                        "PUSCH Mod Order", iPuschModOrder);
    ...
    case 102:
        {
            ...
            for (int i = 0; i < num_record; i++) {
                ...
                _replace_result(result_record_item,
                        "Coding Rate", FieldValue{double(fCodingRate)});
