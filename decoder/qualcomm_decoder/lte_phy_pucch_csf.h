    ...
    case 22:
        {
            ...
            (void) _map_result_field_to_name(result, "PUCCH Reporting Mode",
                    ...
                    "(MI)Unknown");
            _replace_result_int(result, "PUCCH Report Type",
                    iPucchReportType);
            (void) _map_result_field_to_name(result, "PUCCH Report Type",
                    ...
                    "(MI)Unknown");
            _replace_result_int(result, "Size BWP",
                    iSizeBWP);
            ...
            _replace_result_int(result, "Number of Subbands",
                    iNumSubbands);
            _replace_result_int(result, "BWP Index",
                    iBWPIndex);
            _replace_result_int(result, "SubBand Label",
                    iSubBandLabel);
            _replace_result_int(result, "CQI CW0",
                    iCQI0);
            _replace_result_int(result, "CQI CW1",
                    iCQI1);
            _replace_result_int(result, "Wideband PMI",
                    iWidebandPMI);
    ...
    case 24:
        {
            ...
            _replace_result_int(result, "Wideband PMI1",
                    iWidebandPMI1);

            _replace_result_int(result, "Pti",
                    iPti);
    ...
    case 103:
        {
            ...
            _replace_result_int(result, "CSF Tx Mode",
                    iCSFTxMode);
            _replace_result_int(result, "Forced Max RI",
                    iForcedMaxRI);
            (void) _map_result_field_to_name(result, "CSF Tx Mode",
                    ValueNameCSFTxMode,
                    ARRAY_SIZE(ValueNameCSFTxMode, ValueName),
    ...
    case 142:
        {
            ...
            (void) _map_result_field_to_name(result, "Carrier Index",
                    ...
                    ARRAY_SIZE(ValueNameCarrierIndex, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "Scell Index",
                    iScellIndex);
            _replace_result_int(result, "PUCCH Reporting Mode",
                    iPucchReportingMode);
            (void) _map_result_field_to_name(result, "PUCCH Reporting Mode",
            ...
            _replace_result_int(result, "Alt Cqi Table Data",
                    iAltCqiTableData);
            _replace_result_int(result, "SubBand Label",
                    iSubBandLabel);
            _replace_result_int(result, "CQI CW0",
            ...
            (void) _map_result_field_to_name(result, "CSF Tx Mode",
                    ...
                    ARRAY_SIZE(ValueNameCSFTxMode, ValueName),
                    "(MI)Unknown");
            _replace_result_int(result, "PUCCH Reporting Submode",
