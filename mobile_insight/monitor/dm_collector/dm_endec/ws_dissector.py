...
class WSDissector:
    ...
    def decode_msg(cls, msg_type, b):
        ...
        while True:
            ...
            if line == "":
                returncode = cls._proc.poll()
                print("MI(ERROR) child process ws_dissector died. msg_type=%s len=%d returncode=%s" % 
                        (msg_type, len(b), returncode))
                raise RuntimeError("ws_dissector closed stdout (EOF) and died with returncode %s" %returncode)
...
if __name__ == "__main__":
    tests = [
            ...
            #("5G_NR_RRC_OTA_Packet", "7481017010400402add800000cd80018056109a000200046402051320c6b6c61b3704020000100800041a23524121304269349a00000464e35b63224f80b0664abff0124e9106e28dc61b8e372c6fbf56c70ea008580d003058b6822800000000000000000")
            ]
